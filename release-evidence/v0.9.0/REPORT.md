...
| --- | --- | --- | ---: | ---: | ---: |
| capabilities-hierarchy | claude | cold | 3/3 | 14883.0 | n/a |
| capabilities-hierarchy | claude | restart | 3/3 | 13307.0 | n/a |
| capabilities-hierarchy | claude | warm | 3/3 | 10647.0 | n/a |
| capabilities-hierarchy | codex | cold | 3/3 | 18965.0 | 31.0 |
| capabilities-hierarchy | codex | restart | 3/3 | 26290.0 | 44.8 |
| capabilities-hierarchy | codex | warm | 3/3 | 11294.0 | 68.4 |
| researcher-delegation | claude | cold | 3/3 | 11201.0 | n/a |
| researcher-delegation | claude | restart | 3/3 | 10646.0 | n/a |
| researcher-delegation | claude | warm | 3/3 | 9401.0 | n/a |
| researcher-delegation | codex | cold | 3/3 | 28831.0 | 38.7 |
| researcher-delegation | codex | restart | 3/3 | 28622.0 | 46.3 |
| researcher-delegation | codex | warm | 3/3 | 13682.0 | 62.6 |
| vault-recall-and-persistence | claude | cold | 3/3 | 6209.0 | n/a |
| vault-recall-and-persistence | claude | restart | 3/3 | 6227.0 | n/a |
| vault-recall-and-persistence | claude | warm | 3/3 | 5463.0 | n/a |
| vault-recall-and-persistence | codex | cold | 3/3 | 5265.0 | 53.1 |
| vault-recall-and-persistence | codex | restart | 3/3 | 6570.0 | 72.1 |
| vault-recall-and-persistence | codex | warm | 3/3 | 4744.0 | 99.6 |

## Release comparison flags

- `advisory_regression`: ['capabilities-hierarchy', 'codex', 'restart']
- `advisory_regression`: ['capabilities-hierarchy', 'codex', 'restart']
- `advisory_regression`: ['capabilities-hierarchy', 'codex', 'restart']
- `advisory_regression`: ['researcher-delegation', 'codex', 'warm']
