...
### Added
- feat(recall): close the negation and abstention gaps in the evidence drill-down (`9fdd5821`)
- feat(memory): preview a proposal's exact change before accepting it (`505b0e80`)
- feat(insights): wire the structured extraction path to fact candidates (`d92e79cc`)
- feat(memory): make an edited accept undoable from History (`f7dd0398`)
- feat(linux): add VPS hosting support (`6ed6ef00`)
- feat(agent-surface): add the ciao agent CLI and its loopback dispatcher (S0) (`11489026`)
- feat(agent-surface): delete three operations and land the post-experiment fixes (S1) (`59cf1ba9`)
- feat(agent-surface): migrate the rare admin group to the CLI (S2) (`bbdc8955`)
- feat(agent-surface): migrate the chat lifecycle group to the CLI (S3) (`30ed3b22`)
- feat(agent-surface): migrate background runs and schedules to the CLI (S4) (`1a20f246`)
- feat(agent-surface): empty the MCP catalog by migrating the hot-loop group (S5) (`56ceab3f`)
- feat(agent-surface): rewrite hot-loop callers to ciao command wording (S5) (`69fc902f`)
- feat(control-plane): file_surface suggests nearest paths on a miss (Q-08) (`d1af1480`)
- feat(agent-surface): add GET /api/agent/status and drop the /mcp mount (S6) (`4cd29182`)
- feat(settings): replace the ciaobot-fastmcp row with an Agent CLI status panel (S6) (`8b552b97`)

### Changed
- Merge pull request #478 from raffaelefarinaro/chore/sync-develop-v0.17.0 (`0c7d6486`)
- refactor(web): extract the proposal action result type and decision recorder (`fcc1810c`)
- Merge pull request #479 from raffaelefarinaro/fix/issue-452 (`9b783774`)
- Merge pull request #480 from raffaelefarinaro/fix/issue-460 (`eab1d234`)
- Merge pull request #484 from raffaelefarinaro/fix/issue-446 (`7caa47cb`)
- Merge pull request #483 from raffaelefarinaro/fix/issue-456 (`c2ed1388`)
- Merge develop into fix/issue-459 (`a010d916`)
- Merge pull request #482 from raffaelefarinaro/fix/issue-459 (`2f61fb2c`)
- Merge branch 'develop' into fix/issue-453 (`c6ab81d1`)
- Merge pull request #481 from raffaelefarinaro/fix/issue-453 (`999f89e4`)
- Merge pull request #487 from raffaelefarinaro/fix/issue-485 (`095cdbf9`)
- Merge pull request #488 from raffaelefarinaro/fix/issue-486 (`7b4feac6`)
- Merge pull request #489 from raffaelefarinaro/fix/catch-up-client-node (`0d3938c7`)
- refactor(web): type the proposal accept outcomes (`d71e02c9`)
- refactor(web): extract the chat composer and completed-turn Activity row (`9e37971f`)
- Merge pull request #492 from raffaelefarinaro/fix/453-outcomes (`6985a113`)
- Merge pull request #493 from raffaelefarinaro/fix/490 (`341b2822`)
- Merge pull request #494 from raffaelefarinaro/fix/453-chatpanel (`fb7104f8`)
- Merge pull request #495 from raffaelefarinaro/fix/loose (`fab0e71e`)
- refactor(web): split annotations and pure chat helpers out of the projects store (`22e41538`)
- refactor(web): extract the Settings MCP tab into a composable and a panel (`5bba165c`)
- Merge pull request #496 from raffaelefarinaro/fix/453-stores (`5fe7bee3`)
- Merge remote-tracking branch 'origin/develop' into fix/453-settings (`77b5982b`)
- Merge pull request #497 from raffaelefarinaro/fix/453-settings (`d3ff3b04`)
- refactor(web): extract the chat transcript read path out of routes_api (`1c96e3dc`)
- Merge pull request #498 from raffaelefarinaro/fix/453-routes (`5d1cef41`)
- Merge pull request #491 from raffaelefarinaro/raffaelefarinaro/linux (`028887fb`)
- Merge branch 'develop' of https://github.com/raffaelefarinaro/ciaobot into develop (`240f7db5`)
- perf(web): stop rebuilding the known-path rules once per text span (`bbd04cf3`)
- refactor(chat): extract the subagent completion watcher from ProjectChatManager (`8f4e7d18`)
- Merge pull request #504 from raffaelefarinaro/docs/sync-and-port-accuracy (`bb593fd5`)
- Merge remote-tracking branch 'origin/develop' into fix/499-500-501 (`6e1b48cb`)
- Merge pull request #503 from raffaelefarinaro/fix/499-500-501 (`c441a359`)
- refactor(workspace): make AGENTS.md the only workspace guide (`a5c6470e`)
- Merge pull request #505 from raffaelefarinaro/fix/vault-lint-memory-root (`f934bfc7`)
- Merge pull request #506 from raffaelefarinaro/raffaelefarinaro/issuereach (`4e6271f4`)
- Merge pull request #507 from raffaelefarinaro/feat/agents-md-guide (`18fb6dc4`)
- Remove the re-entry chat summary feature (`b2a3cd10`)
- Merge origin/develop into raffaelefarinaro/removeSummary (`83bf3dad`)
- Merge pull request #509 from raffaelefarinaro/raffaelefarinaro/removeSummary (`65d60c2d`)
- memory-curation: add weekly guide-body review to Workspace care (`b5b5830c`)
- Use the on-device Foundation Model for a backfill pre-filter and dictation correction (`6eb9cfd6`)
- refactor(agent-surface): move operations into a shared module-level table (S2a) (`cf8a4265`)
- refactor(agent-surface): collapse the core prompt to the single CLI-first file (S5) (`6fcc7649`)
- refactor(agent-surface): remove the MCP transport and rename the shared core (S6) (`2ffc7cbe`)
- Merge pull request #508 from raffaelefarinaro/raffaelefarinaro/mcpvscli (`c527400d`)
- Merge pull request #510 from raffaelefarinaro/raffaelefarinaro/mcpvscli-s1 (`0a29944f`)
- Merge pull request #512 from raffaelefarinaro/raffaelefarinaro/mcpvscli-s2 (`9b93a455`)
- Merge pull request #513 from raffaelefarinaro/raffaelefarinaro/mcpvscli-s3 (`9a5eeddd`)
- Merge pull request #515 from raffaelefarinaro/raffaelefarinaro/mcpvscli-s5 (`02e840bc`)
- Merge pull request #516 from raffaelefarinaro/raffaelefarinaro/mcpvscli-s6 (`ca9a08ca`)

### Fixed
- fix(mcp): label the usage aggregation window and harden telemetry writes (`c01e6ee4`)
- fix(memory): type the reconcile decision and offer a retry from review (`37d2efb1`)
- fix(memory): validate evidence against a fact-candidate v1 record (`a9b40116`)
- fix(memory): reach the reconcile retry from the review queue (`c9a1fb3d`)
- fix(triage): gate startup triage on the report's own has_issues (`09cabc82`)
- fix(schedules): treat an interrupted run as a missed slot (`61c4a022`)
- fix(schedules): skip startup catch-up on a client node (`aaa48fac`)
- fix(linux): address review findings on update guidance and unit quoting (`fca05116`)
- fix(schedules): correlate a run's outcome with the dispatch that produced it (`9084c989`)
- fix(memory): byte-exact undo, learning source on accept, card strip at phone width (`3ec9083c`)
- fix(linux): pin bundled-app test to macOS and make workspace private (`6134715b`)
- fix(linux): keep WorkingDirectory literal, refuse backslashes (`fdeea17c`)
- fix(linux): fail closed when server type is unknown before restart (`e9ed309f`)
- fix(linux): stage systemd unit in a root-owned private directory (`da7521de`)
- fix(linux): skip macOS desktop rebuild in Linux dev deploys (`e9363fe3`)
- fix(linux): keep application code administrator-owned (`ceb1ba60`)
- fix(preflight): tighten OpenAI key regex to avoid INDEX.md false positive (`da618020`)
- fix(chat): give the CLI-envelope vocabulary one home (`666f20e7`)
- fix(chat): key the notification summary on the record's opening tag (`cd6f649d`)
- fix(chat): a completion is a record that opens with the notification tag (`4616660a`)
- fix(workspace): commit the guide rename, and stop telling agents to write CLAUDE.md (`d1c83580`)
- fix(client): settle a stopped turn and surface a lost host connection (`5ee44cc2`)
- fix(vault): count a root-level MEMORY.md as a memory root (`3323533e`)
- fix(chat): dedupe the Outputs list and collapse it into links (`73b01881`)
- fix(settings): repair the Google account card layout (`5740c89b`)
- fix(ui): keep the model picker inside the viewport (`8f5c5c70`)
- fix(workspace): commit every guide change, and stop fuzzy-resolving the guide probe (`ad9d54cc`)
- fix(workspace): fix the injected prompt and stop the merge corrupting regions (`a918f77b`)
- fix(client): keep a stopped turn unread-free and the outage notice single (`872a799c`)
- fix(workspace): never follow a symlink when writing the guide backup (`2d799ce6`)
- fix(client): key the banner on a mounted ChatPanel, not the URL (`88d52671`)
- fix(agent-surface): apply the S0 review and security-review findings (`eb93917e`)
- fix(agent-surface): address the PR 508 review comments (`80bc020d`)
- fix(agent-surface): address the second PR 508 review round (`eec5c81e`)
- fix(agent-surface): address the third PR 508 review round (`8a6fc8d2`)
- fix(agent-surface): make --chat optional on send/stop/continue, defaulting to the calling chat (`929ab392`)
- fix(agent-surface): recall guidance abstains when a narrower search cannot recover an omitted qualification (`e5eb2333`)
- fix(agent-surface): fail closed on compound CLI commands and preserve pre-existing memory on cleanup (`5afe0c82`)
- fix(agent-surface): address S2 code-review findings (`66fbe9d4`)
- fix(agent-surface): default chat surface is CLI, keeping migrated ops reachable (`65847b7b`)
- fix(agent-surface): keep MCP default and inject the CLI token on both surfaces (S2 security review) (`e2807c21`)
- fix(agent-surface): keep the still-MCP-exposed destructive tool gated in opencode auto (`e00b10dc`)
- fix(agent-surface): address S5 code-review findings (`71572b59`)
- fix(agent-surface): preserve the file-surface event and harden suggestions for the CLI surface (`c65ed2a2`)
- fix(agent-surface): keep lifespan shutdown cleanup in a finally block and retarget the renamed doc (`9acb05e5`)
- fix(agent-surface): remove the argv auto-approval (security P1, S6) (`829fea43`)
- fix(agent-surface): require the ciao prefix for the CLI file-surface touch (`784e21db`)
- fix(agent-surface): keep chat stop/continue target-explicit and harden the comparison runner (`d40e77cc`)
- fix(agent-surface): address the S6 review round (`4fb68e3e`)
- fix(agent-surface): let explicit ciao file surface paths bypass the shell heuristic; retire INTEGRATIONS MCP runtime notes (`fa9d60da`)
...
- docs(capabilities): catalog the memory-proposal preview and edited-accept undo (`b0f77813`)
- docs(chat): name the notification-reading limits left to #502 (`84bae2e3`)
- docs: correct three claims the PR review caught (`f2728b84`)
- docs: three more overpromises, including one the last commit added (`fcc559d4`)
- docs(architecture): describe both stages of the notification rule (`b0551ea9`)
- docs(stock): correct the Claude model list and warn against pinning it (`74dcb4ee`)
- test(agent-surface): relax a source-grep assertion for the S2a operation-table indentation (`9fc13be5`)
- test(agent-surface): update the opencode test for the dropped _chat_system_instructions parameter (`2c8c0b3a`)
- test(agent-surface): port tests to the CLI-only surface and delete the MCP-transport suite (S6) (`9ef094ea`)
- test(eval): port the approval contract to the CLI ask-class invariant and document /api/agent/status (`2d89aeee`)
- docs: rewrite MCP.md as AGENT_CLI.md for the CLI-first model and update references (S6) (`0305ffd1`)
- test(docs): point the proposal-CLI doc contract at AGENT_CLI.md and restore the exception note (`adcda9fe`)
...
### Added
- feat(web): focus the composer when a chat opens (`92774e15`)
- feat(web): show full provider-filtered picker for image-capability prompt (#387) (`a4d63c16`)
- feat(schedules): allow model/provider and archive overrides for system routines (`faff6ea5`)
- feat(cli): keep proposal text and payload out of the shell command (`566de56e`)
- feat(hooks): deny Monitor and detached shell commands, point at background_run_start (`4bf9333f`)
- feat(subagent_tracking): record CLI Monitor/background tasks by taskId (`0c227fc6`)
- feat(dag): opt-in requires post-conditions for subagent nodes (`96ed9ce9`)
- feat(chats): wake the chat when the CLI owning a tracked task is gone (`b5f705dd`)
- feat(chats): sweep CLI tasks orphaned by a restart; mark woken tasks lost (`bc5eebce`)
- feat(web): move archive shortcut to Cmd/Option+Backspace (`d3289d65`)
- feat(memory): add decision history to the proposal review page (`9c776d26`)
- feat(web): comments on rendered HTML artifacts (`5ecd1719`)

### Changed
- Merge pull request #385 from raffaelefarinaro/chore/sync-develop-v0.14.0 (`cbcb5946`)
- Merge pull request #386 from raffaelefarinaro/release/v0.14.0 (`0a68003c`)
- refactor(vault): give the shared link primitives a public home (#382 P1) (`8de07f8d`)
- refactor(insights): one retry policy, typed outcomes (#382 P3) (`12cf6259`)
- refactor(web): extract a pure layout module from MemoryMapView (#382 P4) (`812fd298`)
- refactor(web): proposal-kind descriptor registry (#382 P2) (`c0a11966`)
- Merge pull request #391 from raffaelefarinaro/refactor/vault-link-primitives (`03cd5693`)
- Merge pull request #393 from raffaelefarinaro/refactor/insights-retry-policy (`d4642534`)
- Merge pull request #396 from raffaelefarinaro/fix/insights-text-overflow-no-retry (`12b2e4db`)
- Merge pull request #394 from raffaelefarinaro/refactor/memory-map-layout (`4012bd49`)
- Merge pull request #401 from raffaelefarinaro/fix/accept-guarded-region-write (`e367320b`)
- Merge pull request #388 from raffaelefarinaro/feat/focus-composer-on-chat-open (`036b7d09`)
- Merge pull request #395 from raffaelefarinaro/fix/bounded-drain-test-flake (`e8b176f7`)
- Merge pull request #400 from raffaelefarinaro/fix/dismiss-text-file (`243eabe4`)
- Merge pull request #392 from raffaelefarinaro/refactor/proposal-kind-registry (`9a0351bc`)
- Merge pull request #390 from raffaelefarinaro/fix/claude-session-glob-stall (`d795114b`)
- Merge pull request #397 from raffaelefarinaro/docs/stock-command-updates (`14311cd2`)
- Merge pull request #404 from raffaelefarinaro/raffaelefarinaro/issue-402-stock-commands (`05f549aa`)
- Merge remote-tracking branch 'origin/develop' into raffaelefarinaro/issue-398-background-steering (`e207d8f2`)
- Merge pull request #405 from raffaelefarinaro/raffaelefarinaro/issue-389-pwa-host (`d38736bc`)
- Merge remote-tracking branch 'origin/develop' into raffaelefarinaro/issue-399-cli-task-tracking (`2a323999`)
- Merge remote-tracking branch 'origin/develop' into raffaelefarinaro/issue-398-background-steering (`96b042a5`)
- Merge pull request #403 from raffaelefarinaro/raffaelefarinaro/issue-398-background-steering (`b1a38d5a`)
- Merge pull request #406 from raffaelefarinaro/raffaelefarinaro/issue-399-cli-task-tracking (`b5896106`)
- refactor(mcp): list the whole ciaobot tool catalog again (`a13fd056`)
- Merge pull request #410 from raffaelefarinaro/raffaelefarinaro/removelazymcp (`399fe86e`)
- Merge pull request #409 from raffaelefarinaro/raffaelefarinaro/send_attachments (`46dca850`)
- Merge pull request #412 from raffaelefarinaro/fix/issue-411-launchagent-repoint (`02449961`)
- Merge pull request #408 from raffaelefarinaro/fix/issue-407-schedule-dead-target (`61829f02`)
- Merge pull request #414 from raffaelefarinaro/fix/proposal-history-review-findings (`e3850cdd`)
- Merge develop into feat/artifact-comments (`f4e49cff`)
- Merge pull request #413 from raffaelefarinaro/feat/artifact-comments (`52384fe7`)
- refactor(operator-actions): drop the unrehomed-people tile (`6df5c6bb`)

### Fixed
- fix(memory): extract real user turns from system-schedule chats (`94f96f99`)
- fix(web): mobile lane header truncation and composer scroll button overlap (`cc7f3c1d`)
- fix(web): make re-authenticate usable from clients and fix manual popup (`8cfe208f`)
- fix: cache cross-cwd Claude session lookup to stop event-loop scandir storms (`0a0a60dd`)
- fix(insights): refuse a context overflow on the paths that cannot shrink (`9fa7d531`)
- fix(web): stop the projects store leaking timers and listeners (`e91e840b`)
- fix(memory): route an accepted region fact through the guarded write (`69e1ab0c`)
- fix: resolve cross-cwd session lookups against live directory entries (`38f2601c`)
- fix: let single-shot session lookups bypass the rescan gate (`24367033`)
- fix(memory): normalize proposal decision text (`5f890238`)
- fix: keep the miss path cached and preserve every cross-cwd match (`ac7b57c9`)
- fix(sync): refresh unmodified stock commands on every sync (`2f8de903`)
- fix(config): align pwa_host dataclass default with the .env fallback (`0062b02c`)
- fix(commands): make dismissed fact recovery explicit (`2659aa25`)
- fix(sync): do not prune managed stock commands when the package is unreadable (`247981bf`)
- fix(hooks,dag): address review — deny before rewrite, nested shells, raw regex (`06694cbd`)
- fix(claude): mark CLI disconnected when the between-turns drain loses it (`71c9579b`)
- fix(sync): adopt unmarked stock commands that match a previously shipped revision (`fcd9d45d`)
- fix(chats): bound the orphaned CLI task sweep to recently active chats (`72407491`)
- fix(hooks,dag): catch mid-line & jobs; run subagent in payload cwd (`5f969666`)
- fix(chats): let task-only watchers exit when a restart drain begins (`723925d9`)
- fix(sync): never follow symlinked stock-command markers; write markers atomically (`c19785d9`)
- fix(hooks): ignore escaped ampersands, comments and heredoc bodies (`602f763f`)
- fix(subagent_tracking): detect the CLI-task wake behind the context capsule (`d554d39d`)
- fix(claude): only transport errors mark the drained CLI dead (`399b43f8`)
- fix(hooks): inspect command substitutions for detached launches (`e951bef2`)
- fix(chats): never re-arm a CLI task wake within one process (`2a7902c3`)
- fix(schedules): never dispatch into a dead chat, make failures observable (`20839d06`)
- fix(schedules): narrow the schedule store before replace (mypy) (`83ac1a2c`)
- fix: send attachment-only messages with Cmd+Enter (`8fa6f659`)
- fix(config): discover the installed workspace for bare-shell CLI probes (`754a7c14`)
- fix: keep Cmd+Enter out of open comment popovers (`a9bed374`)
- fix(schedules, config): apply review findings on PR #408 (`0bb26c5b`)
- fix(schedules): clean legacy bindings on retarget, report recoverable targets (`9817a52e`)
- fix: guard setup_workspace against silently repointing live LaunchAgent (`7909767c`)
- fix: make repoint guard non-mutating (`55dd7415`)
- fix(schedules): pin the dispatch provider on a rehomed wall-clock target (`d02b57d8`)
- fix: keep guard when CIAO_LAUNCH_AGENTS_DIR is set but target is real (`a5d97d3b`)
- fix(schedules): record unsettled subagents as skipped, not ok (`c10ce38d`)
- fix: honor CIAO_ALLOW_LAUNCH_AGENT_REPOINT in CLI preflight (`4b475c07`)
- fix(memory): correct decision-history paging, ids, and a broken import (`6765a38e`)
- fix: close the review findings on the decision history (`4d3d011c`)
- fix(web): make artifact comment highlights survive a frame load (`f58eb699`)
- fix: address the Codex review comments on the decision history (`0708b20d`)
- fix(web): consume artifact highlight clicks, keep shared-element ids (`70f5af8c`)
- fix: resolve session blobs against the chat's own agent root (#415) (`bae78521`)
- fix(schedules): hold packaged system definitions across a bundle swap (`722830eb`)
- fix: apply the v0.15.0 release review findings (`438d929f`)
- fix(config, artifact): stop the dotenv export leaking; close two review gaps (`6783f197`)
- fix: close the remaining three review findings (`6918164d`)

### Maintenance
- docs: credit the post-prepare fixes in the v0.14.0 changelog (`f67e4657`)
- docs(license): canonical Apache-2.0 text for GitHub detection (`928861bf`)
- test(web): align system-routine card test with editable Engine/Advanced cards (`501e266b`)
- docs(commands): tighten critique, interrogation, and remember stock commands (`80355a08`)
- test(chats): accept force_refresh in patched session lookups (`49ec8193`)
- docs: document CIAO_ALLOW_LAUNCH_AGENT_REPOINT in INTEGRATIONS.md (`b3b5648a`)
- chore(deps): bump pip to 26.2.1 in uv.lock (`8c93ebae`)
- docs: document vault_review and artifact comments (`db67d249`)
...
### Fixed
- Startup sync no longer commits provider credentials: the ignore guard is verified with `git check-ignore` rather than by reading .gitignore, untracked files are listed individually so their names reach the guard, and credential filenames are refused wherever they sit. direnv's `.envrc` is protected too (`a3e4fab9`, `fdaea8f3`, `27b457a3`, `235a3808`)
...
- Long messages are read in full, split on real sentence boundaries, with a character-boundary fallback for a token too long to split on words (`68514196`, `27b457a3`, `235a3808`)
...
- Token usage and context % show on Claude chat history, attributed to the right turn in resumed sessions and while a turn is still streaming (`4b038949`, `27b457a3`, `235a3808`)
...
- Picker workspace browsing no longer moves the app, and its keys are claimed ahead of global shortcuts; section chords no longer navigate underneath the open picker (`031cc305`, `fdaea8f3`, `27b457a3`)
