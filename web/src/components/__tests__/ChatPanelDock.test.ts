...
// The interval cadence that replaced loops: bound to this chat via
// `web_chat_id`, so it is what the context bar counts and renders.
function makeIntervalSchedule(scheduleId: string): Schedule {
  return {
