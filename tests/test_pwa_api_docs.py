...
BROWSER_OR_INTERNAL_ROUTES: dict[str, str] = {
    ...
    "/api/loops": "deprecated alias for interval schedules; agents use /api/schedules with frequency=interval",
    "/api/loops/{loop_id}": "deprecated alias for interval schedules; agents use /api/schedules",
    "/api/loop-run/{loop_id}": "deprecated alias for /api/schedule-run/{schedule_id}",
