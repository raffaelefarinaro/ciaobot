...
BROWSER_OR_INTERNAL_ROUTES: dict[str, str] = {
    ...
    "/api/schedules": "agents create/edit schedules via the ciao-automations skill, not curl",
    "/api/schedules/{schedule_id}": "agents edit schedules via the ciao-automations skill, not curl",
