...
- `uv run --project . --extra test pytest -n auto tests/` — 4621 passed, 1 skipped.
- `cd web && npm test` — 1469 passed across 113 files.
- `cd web && npm run build` — typecheck and production build passed.
- `mypy ciao` and `mypy --no-incremental ciao` pass (139 source files).
