...
ciao/                          Python backend (Starlette).
  ...
  observability/               Hooks: PreToolUse (keep Claude Bash jobs in the active turn), UserPromptSubmit (runtime context + vault entity tags), and PostToolUse (WebSearch backfill on Ollama-cloud routes). Plus logging, transcript capture.
