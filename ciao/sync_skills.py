...
def _seed_stock_commands(workspace: Path) -> StockCommandSync:
    ...
    marker is adopted only when it is byte-identical to the packaged text;
    otherwise it is treated as user-authored and left alone. Marked copies
    ...
    for stock_entry in stock_files:
        ...
        with resources.as_file(stock_entry) as stock_path:
            ...
            if marker_digest is None:
                ...
                # copy, treat anything else as user-authored.
                if canonical.read_bytes() == stock_bytes:
