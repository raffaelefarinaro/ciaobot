    ...
    def _create_onboarding_chat(self, project_id: str) -> None:
        ...
        if vault_mode == "existing":
            ...
            user_msg = (
                ...
                f"1. **Inventory first**: Scan the vault and report its top-level files and folders, separating user notes from Ciaobot-managed files (`.env`, `.runtime/`, `.claude/`, `AGENTS.md`, `AGENTS.md`). Do not assume an unfamiliar folder is disposable.\n"
