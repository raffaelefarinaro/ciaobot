    ...
    def _create_onboarding_chat(self, project_id: str) -> None:
        ...
        if vault_mode == "existing":
            ...
            user_msg = (
                ...
                f"4. **Workspace Git Check**: Verify the workspace is a git repository with a `.gitignore` covering `.env` and `.runtime/`. If not, fix it (`git init`, append the missing entries) and report what you did.\n"
            ...
            user_msg = (
                ...
                f"3. **Workspace Git Check**: Verify the workspace is a git repository with a `.gitignore` covering `.env` and `.runtime/`. If not, fix it (`git init`, append the missing entries) and report what you did.\n"
