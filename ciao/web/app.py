...
def create_app(config, app_settings=None, mcp_service=None) -> Starlette:
    ...
    routes = [
        ...
        Route("/api/workspaces/{name}/vault", relocate_workspace_vault, methods=["POST"]),
        Route("/api/workspaces/browse-folder", browse_workspace_folder_endpoint, methods=["GET"]),
        Route("/api/workspaces/browse-folder", create_workspace_folder_endpoint, methods=["POST"]),
        ...
        Route("/api/integrations/gws/profiles/add", gws_add_profile, methods=["POST"]),
        Route("/api/integrations/gws/profiles/remove", gws_remove_profile, methods=["POST"]),
