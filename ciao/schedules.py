...
class ScheduleManager:
    ...
    async def catch_up(self, now: datetime | None = None) -> list[str]:
        ...
        Interval entries are excluded outright. They have no expected slot to
        have missed — resuming the cadence is the correct recovery, and the
        regular tick does that on its own within one interval of boot. Firing
        them here would mean every restart re-runs every interval entry at once.
