...
1. **Instruction quality** — repeated user corrections (AGENTS.md/memory edits), skills that errored or needed workarounds, and redundant or contradictory instructions across AGENTS.md, agents, commands, and schedule prompts.
