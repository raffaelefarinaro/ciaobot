...
4. **Prompt hygiene** — review AGENTS.md, CLAUDE.md, canonical `subagents/*.md` and `commands/*.md`, their generated `.claude/` mirrors, and prompts in `.runtime/schedules.json` for contradictions, bloat, and outdated paths. File + short before/after per issue.
