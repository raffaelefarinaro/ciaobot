...
```bash
scripts/gws-profile.sh "$GWS_PROFILE" slides <resource> <method> [flags]
```
...
scripts/gws-profile.sh "$GWS_PROFILE" slides --help

# Inspect a method's required params, types, and defaults
scripts/gws-profile.sh "$GWS_PROFILE" schema slides.<resource>.<method>
```
