...
```bash
scripts/gws-profile.sh "$GWS_PROFILE" calendar <resource> <method> [flags]
```
...
scripts/gws-profile.sh "$GWS_PROFILE" calendar --help

# Inspect a method's required params, types, and defaults
scripts/gws-profile.sh "$GWS_PROFILE" schema calendar.<resource>.<method>
```
