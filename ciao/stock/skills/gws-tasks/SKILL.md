...
```bash
scripts/gws-profile.sh <personal|work> tasks <resource> <method> [flags]
```
...
scripts/gws-profile.sh <personal|work> tasks --help

# Inspect a method's required params, types, and defaults
scripts/gws-profile.sh <personal|work> schema tasks.<resource>.<method>
```
