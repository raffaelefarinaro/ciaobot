...
```bash
scripts/gws-profile.sh <personal|work> sheets <resource> <method> [flags]
```
...
scripts/gws-profile.sh <personal|work> sheets --help

# Inspect a method's required params, types, and defaults
scripts/gws-profile.sh <personal|work> schema sheets.<resource>.<method>
```
